...
; Rooms definitions
	...
	( item (type Door) (name entrance)(possession office)(attributes no_visited)(room Dummy) (pose -3.55 -3.0 0.0))
	( item (type Door) (name exit)(possession living_room)(attributes no_visited)(room Dummy)(pose -1.87 8.64 0.0))
