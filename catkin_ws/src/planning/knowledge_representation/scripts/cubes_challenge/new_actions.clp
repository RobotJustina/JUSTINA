...
(defrule plan_explain_cubes_plan
	...
	(assert (plan (name ?name) (number 4)(actions backup_cubes green_block)))
	(assert (plan (name ?name) (number 5)(actions enable_simul True)))
	(assert (plan (name ?name) (number 6)(actions go_to_place table)))
	(assert (plan (name ?name) (number 7)(actions put_on_top_simul ?block1 ?block2)))
	(assert (plan (name ?name) (number 8)(actions go_to_place dining_room)))
	(assert (plan (name ?name) (number 9)(actions enable_simul False)))
	(assert (plan (name ?name) (number 10)(actions update_status original nil)))
	(assert (plan (name ?name) (number 11)(actions restore_stacks)))
	...
	(assert (plan (name ?name) (number 15)(actions speech-anything ?speech1)))
	...
	(assert (plan (name ?name) (number 19)(actions update_status stack_exp explained)))
