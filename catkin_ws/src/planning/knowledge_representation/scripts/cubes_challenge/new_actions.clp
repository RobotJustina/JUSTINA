...
(defrule plan_explain_cubes_plan
	...
	(assert (plan (name ?name) (number 2)(actions make_task ?name stack_exp explained) (actions_num_params 3 18)))
	...
	(assert (plan (name ?name) (number 13)(actions restore_cubes blue_block)))
	(assert (plan (name ?name) (number 14)(actions restore_cubes red_block)))
	(assert (plan (name ?name) (number 15)(actions restore_cubes green_block)))
	(assert (plan (name ?name) (number 16)(actions reset_cube_pos blue_block)))
	(assert (plan (name ?name) (number 17)(actions reset_cube_pos red_block)))
	(assert (plan (name ?name) (number 18)(actions reset_cube_pos green_block)))
	(assert (plan (name ?name) (number 19)(actions restore_stacks_dynamic delate)))
