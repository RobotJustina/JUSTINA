...
(defrule move-directly
	...
	(assert (plan (name cubes) (number 2 )(actions align_with_point ?block1 map base_link)(duration 6000)))
        (assert (plan (name cubes) (number 3 )(actions find-object ?block1)(duration 6000)))
	...
	(assert (plan (name cubes) (number 6 ) (actions align_with_point ?block2 map base_link)(duration 6000)))
	(assert (plan (name cubes) (number 7 ) (actions only-find-object ?block2)(duration 6000)))
        (assert (plan (name cubes) (number 8 )(actions place-block ?block1 ?block2)(duration 6000)))
	(assert (plan (name cubes) (number 9 ) (actions only-find-object ?block1)(duration 6000)))
	(assert (plan (name cubes) (number 10)(actions pile ?block1 ?block2)(duration 6000)))
	(assert (finish-planner cubes 10))
