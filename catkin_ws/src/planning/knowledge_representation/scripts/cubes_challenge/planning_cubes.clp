...
(defrule move-directly
	...
	(assert (plan (name cubes) (number 7 )(actions pile ?block1 ?block2)(duration 6000)))
	(assert (plan (name cubes) (number 8 )(actions go_to_place table)(duration 6000)))
...
(defrule move-to-table
	...
	(assert (plan (name cubes) (number 6 )(actions pile ?block1)(duration 6000)))
