...
(defrule move-directly
	...
	(assert (plan (name ?name) (number 1 )(actions go_to ?block1)(duration ?*plan_time*)) )
	(assert (plan (name ?name) (number 2 )(actions attend ?block1)(duration ?*plan_time*)) )
        (assert (plan (name ?name) (number 3 )(actions find-object ?block1)(duration ?*plan_time*)) )
        (assert (plan (name ?name) (number 4 )(actions find-object ?block2)(duration ?*plan_time*)) )
        (assert (plan (name ?name) (number 5 )(actions move manipulator ?block1 )(duration ?*plan_time*)) )
        ...
        (assert (plan (name ?name) (number 6 )(actions drop object ?block1 )(duration ?*plan_time*)) )
	(assert (attempt (move ?block1) (on-top-of ?block2)(number 6 )))
)
...
(defrule move-to-table
	...
	(assert (plan (name ?name) (number 1 )(actions got_to ?block1)(duration ?*plan_time*)) )
	(assert (plan (name ?name) (number 2 )(actions attend ?block1)(duration ?*plan_time*)) )
        (assert (plan (name ?name) (number 3 )(actions find-object ?block1)(duration ?*plan_time*)) )
        ;(assert (plan (name ?name) (number (+ 2 ?num))(actions find-object cubestable)(duration ?*plan_time*)) )
        (assert (plan (name ?name) (number 4 )(actions move manipulator ?block1 )(duration ?*plan_time*)) )
        ;(assert (plan (name ?name) (number (+ 4 ?num))(actions grab manipulator ?block1 )(duration ?*plan_time*)) )
        ;(assert (plan (name ?name) (number (+ 5 ?num))(actions move manipulator cubestable )(duration ?*plan_time*)) )
        (assert (plan (name ?name) (number 5 )(actions drop object ?block1 )(duration ?*plan_time*)) )
	(assert (attempt (move ?block1) (on-top-of cubestable)(number 5 ) ))
)
