...
(defrule move-directly
	...
	(assert (plan (name cubes) (number 5 ) (actions align_with_point ?block2 map base_link)(duration 6000)))
	(assert (plan (name cubes) (number 6 ) (actions only-find-object ?block2)(duration 6000)))
