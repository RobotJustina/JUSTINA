...
(defrule move-directly
	...
	(assert (plan (name cubes) (number 5 ) (actions align_with_point ?block2)(duration 6000)))
	(assert (plan (name cubes) (number 6 ) (actions only-find-object ?block2 map base_link)(duration 6000)))
        (assert (plan (name cubes) (number 7 )(actions place-block ?block1 ?block2)(duration 6000)))
