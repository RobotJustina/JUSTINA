...
(defrule plan_ask_for
	...
	(assert (plan (name ?name) (number 1)(actions rev_arms right left)(duration 6000)))
	(assert (plan (name ?name) (number 2)(actions make_task ?name right ready)(actions_num_params 3 3)(duration 6000)))
	(assert (plan (name ?name) (number 3)(actions drop object arm right)(duration 6000)))
	(assert (plan (name ?name) (number 4)(actions ask_for ?param ?place)(duration 6000)))
	(assert (plan (name ?name) (number 5)(actions go_to ?param)(duration 6000)))
