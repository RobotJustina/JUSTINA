...
(defrule plan_offer_eat_drink
	...
	(assert (plan (name ?name) (number 4) (actions make_task ?name person went)(actions_num_params 5 9) (duration 6000)))
	...
	(assert (plan (name ?name) (number 7) (actions offer_drink ?eatdrink) (actions_num_params 1) (duration 6000)));;offer one drink
	(assert (plan (name ?name) (number 8) (actions make_task ?name offer offered)(actions_num_params 9 9)(duration 6000)))
	(assert (plan (name ?name) (number 9) (actions train_person)(duration 6000)))
	(assert (plan (name ?name) (number 10) (actions repeat_task ?name people last_offer) (actions_num_params 3 9 1 2) (duration 6000)))
	(assert (plan (name ?name) (number 11) (actions set_plan_status ?name)(actions_num_params 3 10)(duration 6000)))

	(assert (plan (name ?name) (number 12) (actions set_plan_status ?name)(actions_num_params 13 15)(duration 6000)))
	(assert (plan (name ?name) (number 13) (actions make_task ?name offer offered)(actions_num_params 14 16)(duration 6000)))	
	(assert (plan (name ?name) (number 14) (actions get_ordered_objects bar)(actions_num_params 1 1)(duration 6000)));;;(actions_params obj_per_attemp total_orders)
	(assert (plan (name ?name) (number 15) (actions deliver_order ?place) (duration 6000)))
	(assert (plan (name ?name) (number 16) (actions repeat_task ?name people deliver_order) (actions_num_params 13 15 1 2) (duration 6000)))
	(assert (plan (name ?name) (number 17) (actions set_plan_status ?name)(actions_num_params 13 15)(duration 6000)))
	(assert (plan (name ?name) (number 18) (actions update_status finish_objetive finish_test)(duration 6000)))
