...
(defrule plan_offer_eat_drink
	...
	(assert (plan (name ?name) (number 13) (actions set_plan_status ?name) (actions_num_params 3 9) (duration 6000)))
	(assert (plan (name ?name) (number 11) (actions go_to_place current_loc) (duration 6000)))
	(assert (plan (name ?name) (number 12) (actions speech-oreder) (duration 6000)))
	(assert (plan (name ?name) (number 14) (actions update_status offer final_offer) (duration 6000)))
...
(defrule plan_offer_eat_drink_dsc
	...
	(assert (plan (name ?name) (number 7) (actions confirmation ?confirmation1) (duration 6000)))
	(assert (plan (name ?name) (number 8) (actions make_task ?name) (actions_num_params 9 9) (duration 6000)))
	(assert (plan (name ?name) (number 9) (actions ask_and_offer ?ppl ?eatdrink ?place)))
	(assert (plan (name ?name) (number 10) (actions repeat_task ?name ?ppl offer) (actions_num_params 3 9 1 3) (duration 6000)))
	(assert (plan (name ?name) (number 13) (actions set_plan_status ?name) (actions_num_params 3 9) (duration 6000)))
	(assert (plan (name ?name) (number 11) (actions go_to_place current_loc)(duration 6000)))
	(assert (plan (name ?name) (number 12) (actions speech-order) (duration 6000)))
	(assert (plan (name ?name) (number 14) (actions update_status offer final_offer) (duration 6000)))
	(assert (finish-planner ?name 14))
)
...
(defrule plan_bring-obj-to-person 
	...
	(assert (plan (name ?name) (number 1)(actions set_plan_status ?name) (actions_num_params 8 12) (duration 6000)))
	...
	(assert (plan (name ?name) (number 6)(actions make_task ?name ?obj grabed)(actions_num_params 7 15)(duration 6000)))
	(assert (plan (name ?name) (number 7)(actions go_to_place ?place)(duration 6000)))
	(assert (plan (name ?name) (number 8)(actions find-person person ?place)(duration 6000)))
	...
	(assert (plan (name ?name) (number 16)(actions set_plan_status ?name) (actions_num_params 8 12) (duration 6000)))
	(assert (plan (name ?name) (number 17)(actions update_status ?obj handover)(duration 6000)))
...
(defrule plan_greet-person-dsc 
	...
	(printout t "Prueba Nuevo PLAN greet person")
	(bind ?confirmation(str-cat "Hello_i_am_looking_for_a_" ?peopleDsc "_" ?ppl ",_tell_me_are_you_a_" ?peopleDsc "_" ?ppl ))
	(assert (plan (name ?name) (number 1)(actions set_plan_status ?name)(actions_num_params 3 7)(duration 6000)))	
	(assert (plan (name ?name) (number 2)(actions go_to_place ?place)(duration 6000)))
...
(defrule plan_follow_person
	...
	(assert (plan (name ?name) (number 8)(actions repeat_task ?name ?ppl find)(actions_num_params 3 7 1 3)(duration 6000)))
	(assert (plan (name ?name) (number 9)(actions make_task ?name)(actions_num_params 10 10)(duration 6000)))
	(assert (plan (name ?name) (number 10)(actions find-object-man man no_location)(duration 6000)))
	(assert (plan (name ?name) (number 11) (actions set_plan_status ?name) (actions_num_params 3 7) (duration 6000)))
...
(defrule plan_follow_person_outfit
	...
	(assert (plan (name ?name) (number 6)(actions update_status ?ppl find)(duration 6000)))
	(assert (plan (name ?name) (number 7)(actions update_status conf true)(duration 6000)))
	(assert (plan (name ?name) (number 8)(actions repeat_task ?name ?ppl finded)(actions_num_params 3 7 1 3)))
	(assert (plan (name ?name) (number 9)(actions make_task ?name)(actions_num_params 10 10)(duration 6000)))
	(assert (plan (name ?name) (number 10)(actions find-object-man man no_location)(duration 6000)))
	(assert (plan (name ?name) (number 11)(actions set_plan_status ?name)(actions_num_params 3 7) (duration 6000)))
	(assert (plan (name ?name) (number 12)(actions update_status man followed_person)(duration 6000)))
...
(defrule plan_guide-person
	...
	(assert (plan (name ?name) (number 3)(actions find-person person ?place1)(duration 6000)))
