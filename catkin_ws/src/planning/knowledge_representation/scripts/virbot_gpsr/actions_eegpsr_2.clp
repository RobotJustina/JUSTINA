...
(defrule plan_offer_eat_drink
	...
	(assert (plan (name ?name) (number 1)(actions set_plan_status ?name)(actions_num_params 3 12)(duration 6000)))
	(assert (plan (name ?name) (number 2)(actions go_to_place ?place)(duration 6000)))
	
	(assert (plan (name ?name) (number 3) (actions find-person person ?place)(duration 6000)))
	(assert (plan (name ?name) (number 4) (actions make_task ?name person went)(actions_num_params 7 11) (duration 6000)))
	(assert (plan (name ?name) (number 5) (actions confirmation ?confirmation) (duration 6000)))
	(assert (plan (name ?name) (number 6) (actions make_task ?name) (actions_num_params 9 11)))
	(assert (plan (name ?name) (number 7) (actions offer_drink ?eatdrink) (actions_num_params 1) (duration 6000)));;offer one drink
	(assert (plan (name ?name) (number 8) (actions make_task ?name offer offered)(actions_num_params 11 11)(duration 6000)))
	(assert (plan (name ?name) (number 9) (actions train_person)(duration 6000)))
	(assert (plan (name ?name) (number 10) (actions repeat_task ?name people last_offer) (actions_num_params 3 9 1 5) (duration 6000)))
	
	(assert (plan (name ?name) (number 11) (actions get_ordered_objects bar)(actions_num_params 1 1)(duration 6000)));;;(actions_params obj_per_attemp total_orders)
	;(assert (plan (name ?name) (number 16) (actions find-person specific)(actions_num_params 1 2)(duration 6000)))
	(assert (plan (name ?name) (number 12) (actions deliver_order ?place) (duration 6000)))
	(assert (plan (name ?name) (number 13) (actions repeat_task ?name people deliver_order) (actions_num_params 3 12 1 5) (duration 6000)))
	(assert (plan (name ?name) (number 14) (actions set_plan_status ?name)(actions_num_params 15 16)(duration 6000)))
	(assert (plan (name ?name) (number 15) (actions update_status finish_objetive finish_test)(duration 6000)))
