...
(defrule plan_greet-known-name 
	...
	(assert (plan (name ?name) (number 1)(actions set_plan_status ?name)(actions_num_params 6 10)(duration 6000)))
	(assert (plan (name ?name) (number 2)(actions update_status incomplete nil)(duration 6000)))
	(assert (plan (name ?name) (number 3)(actions get_person_description ?place)(actions_num_params 6 6)(duration 6000)))
...
(defrule plan_offer_eat_drink_known_person
	...
	(assert (plan (name ?name) (number 2)(actions update_status incomplete nil)(duration 6000)))
	(assert (plan (name ?name) (number 3)(actions get_person_description ?place)(actions_num_params 7 7)(duration 6000)))
	(assert (plan (name ?name) (number 4)(actions make_task ?name incomplete asked)(actions_num_params 5 13)))
	(assert (plan (name ?name) (number 5) (actions go_to_place ?place) (duration 6000)))
...
(defrule plan_guide-known-person
	...
	(assert (plan (name ?name) (number 1)(actions set_plan_status ?name)(actions_num_params 6 10) (duration 6000)))
	(assert (plan (name ?name) (number 2)(actions update_status incomplete nil)(duration 6000)))
	(assert (plan (name ?name) (number 3)(actions get_person_description ?place1)(actions_num_params 6 6)(duration 6000)))
	(assert (plan (name ?name) (number 4)(actions make_task ?name incomplete asked)(actions_num_params 5 13)))
