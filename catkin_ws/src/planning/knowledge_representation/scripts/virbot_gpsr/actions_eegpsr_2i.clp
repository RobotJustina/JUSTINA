...
(defrule plan_greet-person-no-location 
	...
	(assert (plan (name ?name) (number 11)(actions repeat_task ?name ?ppl find)(actions_num_params 6 10 1 3)(duration 6000)))
	...
	(assert (plan (name ?name) (number 13)(actions answer_question question_1 introduce_yourself)(duration 6000)))
	(assert (plan (name ?name) (number 14)(actions set_plan_status ?name)(actions_num_params 6 10)(duration 6000)))
	(assert (plan (name ?name) (number 15)(actions update_status question_1 greeted)(duration 6000)))
...
(defrule plan_greet-person-no-location-a
	...
	(assert (plan (name ?name) (number 3)(actions make_task ?name incomplete asked)(actions_num_params 4 5)))
	...
	(assert (plan (name ?name) (number 6)(actions answer_question question_1 introduce_yourself)(duration 6000)))
	(assert (plan (name ?name) (number 7)(actions update_status question_1 greeted)(duration 6000)))
...
(defrule plan_offer_eat_drink_known_person
	...
	(assert (plan (name ?name) (number 9) (actions make_task ?name) (actions_num_params 10 13) (duration 6000)))
	...
	(assert (plan (name ?name) (number 12) (actions make_task ?name) (actions_num_params 12 12) (duration 6000)))
	(assert (plan (name ?name) (number 13) (actions ask_and_offer ?ppl ?eatdrink ?place)))
	(assert (plan (name ?name) (number 14) (actions repeat_task ?name ?ppl find) (actions_num_params 6 13 1 3) (duration 6000)))
	(assert (plan (name ?name) (number 15) (actions go_to_place current_loc)(duration 6000)))
	(assert (plan (name ?name) (number 16) (actions speech-order) (duration 6000)))
...
(defrule plan_follow_person
	...
	(assert (plan (name ?name) (number 11)(actions repeat_task ?name ?ppl find)(actions_num_params 6 10 1 3)(duration 6000)))
	(assert (plan (name ?name) (number 12)(actions make_task ?name)(actions_num_params 13 13)(duration 6000)))
	(assert (plan (name ?name) (number 13)(actions find-object-man man no_location)(duration 6000)))
	(assert (plan (name ?name) (number 14)(actions set_plan_status ?name) (actions_num_params 6 10) (duration 6000)))
	(assert (plan (name ?name) (number 15)(actions update_status man followed_person)(duration 6000)))
	(assert (finish-planner ?name 15))
)
...
(defrule plan_guide-known-person
	...
	(assert (plan (name ?name) (number 11)(actions repeat_task ?name ?ppl find)(actions_num_params 6 10 1 3)(duration 6000)))
	(assert (plan (name ?name) (number 12)(actions make_task ?name)(actions_num_params 13 13)(duration 6000)))
	(assert (plan (name ?name) (number 13)(actions find-object-man man_guide ?place2)))
	(assert (plan (name ?name) (number 14)(actions set_plan_status ?name)(actions_num_params 6 10) (duration 6000)))
...
(defrule plan_find_how_many_people_no_location 
	...
	(assert (plan (name ?name) (number 8)(actions update_status ?ppl finded) (duration 6000)))
...
(defrule plan_offer_eat_drink_no_location
	...
	(assert (plan (name ?name) (number 4)(actions make_task ?name incomplete asked)(actions_num_params 5 15)(duration 6000)))
	(assert (plan (name ?name) (number 5) (actions go_to_place) (duration 6000)))
	(assert (plan (name ?name) (number 6) (actions get_amount_people) (duration 6000)))
	(assert (plan (name ?name) (number 7) (actions find-person person) (duration 6000)))
	(assert (plan (name ?name) (number 8) (actions confirmation ?confirmation) (duration 6000)))
	(assert (plan (name ?name) (number 9) (actions make_task ?name) (actions_num_params 10 12)))
	...
	(assert (plan (name ?name) (number 12) (actions ask_and_offer ?ppl ?eatdrink kitchen) (duration 6000)))
	(assert (plan (name ?name) (number 13) (actions repeat_task ?name ?ppl offer) (actions_num_params 3 12 1 3) (duration 6000)))
	...
	(assert (plan (name ?name) (number 15) (actions speech-oreder) (duration 6000)))
...
(defrule plan_offer_eat_drink_dsc_no_location
	...
	(assert (plan (name ?name) (number 5) (actions go_to_place ?place) (duration 6000)))
	(assert (plan (name ?name) (number 6) (actions get_amount_people ?place) (duration 6000)))
	(assert (plan (name ?name) (number 7) (actions find-person person ?place) (duration 6000)))
	(assert (plan (name ?name) (number 8) (actions confirmation ?confirmation) (duration 6000)))
	(assert (plan (name ?name) (number 9) (actions make_task ?name) (actions_num_params 10 12) (duration 6000)))
	(assert (plan (name ?name) (number 10) (actions confirmation ?confirmation1) (duration 6000)))
	(assert (plan (name ?name) (number 11) (actions make_task ?name) (actions_num_params 12 12) (duration 6000)))
	(assert (plan (name ?name) (number 12) (actions ask_and_offer ?ppl ?eatdrink ?place)))
...
(defrule plan_guide_man_no_location 
	...
	(retract ?goal)
	(assert (plan (name ?name) (number 1)(actions update_status incomplete nil)(duration 6000)))
	(assert (plan (name ?name) (number 2)(actions ask_for_incomplete ?ppl destiny)(actions_num_params 6 6)(duration 6000)))
...
(defrule plan_guide-person-no-location 
	...
	(assert (plan (name ?name) (number 2)(actions ask_for_incomplete ?ppl destiny)(actions_num_params 12 12)(duration 6000)))
...
(defrule plan_guide-person-outfit_no_location 
	...
	(assert (plan (name ?name) (number 10)(actions repeat_task ?name ?ppl find)(actions_num_params 5 9 1 3)(duration 6000)))
	(assert (plan (name ?name) (number 11)(actions make_task ?name)(actions_num_params 12 12)(duration 6000)))
	(assert (plan (name ?name) (number 12)(actions find-object-man man_guide)(duration 6000)))
	(assert (plan (name ?name) (number 13)(actions set_plan_status ?name)(actions_num_params 5 9)(duration 6000)))
	(assert (plan (name ?name) (number 14)(actions update_status man_guide followed_person)(duration 6000)))
	(assert (finish-planner ?name 14))
)
