...
(defrule plan_serving_drinks
	...
	(assert (plan (name ?name) (number 6) (actions make_task ?name person finded)(actions_num_params 7 11) (duration 6000)))
	...
	(assert (plan (name ?name) (number 14)(actions set_plan_status test)(actions_num_params 15 17)(duration 6000)))
