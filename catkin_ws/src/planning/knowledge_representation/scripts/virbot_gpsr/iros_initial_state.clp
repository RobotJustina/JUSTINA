...
;;;;;;;;;;;IROS 2018 names
	...
	(item (type Pile) (name james_dato_3)(image steve)(num 3) (zone bedroom))
	(item (type Pile) (name james_dato_2)(image steve)(num 2) (zone living_room))
	(item (type Pile) (name james_dato_1)(image steve)(num 1) (zone kitchen))
	
	(item (type Pile) (name alex_dato_3)(image robert)(num 3) (zone bedroom))
	(item (type Pile) (name alex_dato_2)(image robert)(num 2) (zone living_room))
	(item (type Pile) (name alex_dato_1)(image robert)(num 1) (zone kitchen))
	
	(item (type Pile) (name jamie_dato_3)(image luis)(num 3) (zone bedroom))
	(item (type Pile) (name jamie_dato_2)(image luis)(num 2) (zone living_room))
	(item (type Pile) (name jamie_dato_1)(image luis)(num 1) (zone kitchen))
	
	(item (type Pile) (name morgan_dato_3)(image john)(num 3) (zone bathroom))
	(item (type Pile) (name morgan_dato_2)(image john)(num 2) (zone bedroom))
	(item (type Pile) (name morgan_dato_1)(image john)(num 1) (zone dining_room))
	
	(item (type Pile) (name taylor_dato_3)(image james)(num 3) (zone bathroom))
	(item (type Pile) (name taylor_dato_2)(image james)(num 2) (zone bedroom))
	(item (type Pile) (name taylor_dato_1)(image james)(num 1) (zone dining_room))
