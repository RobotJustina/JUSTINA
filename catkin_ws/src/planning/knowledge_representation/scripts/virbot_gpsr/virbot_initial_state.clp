...
;;;;;;;;;;;NAGOYA 2017 names
	...
	(item (type Objects) (name chips) (zone center_table) (image chips) (attributes pick) (pose 0.0 0.0 0.0) (category snacks) (room living_room))
	...
	(item (type Objects) (name pringles) (zone center_table) (image pringles) (attributes pick) (pose 0.0 0.0 0.0) (category snacks) (room living_room))
	(item (type Objects) (name cookies) (zone center_table) (image cookies) (attributes pick) (pose 0.0 0.0 0.0) (category snacks) (room living_room))

	;;; DRINKS
	(item (type Objects) (name tea)(zone fridge)(image tea)(attributes pick)(pose -3.55 -3.0 0.0) (category drinks) (room kitchen) (color silver)(grasp 8)(size 6) (wide 3) (height 8) (weight 12)(heaviest yes))
	(item (type Objects) (name beer)(zone fridge)(image beer)(attributes pick)(pose -3.55 -3.0 0.0) (category drinks) (room kitchen) (color brown)(grasp 11)(size 7) (wide 11) (height 9) (weight 11))
	(item (type Objects) (name coke)(zone fridge)(image coke)(attributes pick)(pose -3.55 -3.0 0.0) (category drinks) (room kitchen) (color pink)(size 5) (wide 4) (height 7) (weight 8)(grasp 10))
	(item (type Objects) (name water)(zone fridge)(image water)(attributes pick)(pose -3.55 -3.0 0.0) (category drinks) (room kitchen) (color brown)(size 8) (wide 5) (height 10) (weight 5)(grasp 9))
	...
	(item (type Objects) (name pasta) (zone cabinet) (image pasta) (attributes pick) (pose 0.0 0.0 0.0) (category food) (room kitchen))
	(item (type Objects) (name noodles) (zone cabinet) (image noodles) (attributes pick) (pose 0.0 0.0 0.0) (category food) (room kitchen))
	(item (type Objects) (name tuna_fish) (zone cabinet) (image tuna_fish) (attributes pick) (pose 0.0 0.0 0.0) (category food) (room kitchen))
	(item (type Objects) (name pickles) (zone cabinet) (image pickles) (attributes pick) (pose 0.0 0.0 0.0) (category food) (room kitchen))

	(item (type Objects) (name choco_flakes) (zone cupboard) (image choco_flakes) (attributes pick) (pose 0.0 0.0 0.0) (category food) (room kitchen))
	(item (type Objects) (name robo_o_s) (zone cupboard) (image robo_o_s) (attributes pick) (pose 0.0 0.0 0.0) (category food) (room kitchen))
	(item (type Objects) (name muesli) (zone cupboard) (image muesli) (attributes pick) (pose 0.0 0.0 0.0) (category food) (room kitchen))

	;;;; TOILETRIES
	(item (type Objects) (name shampoo) (zone bathroom_s_cabinet) (image shampoo) (attributes pick) (pose 0.0 0.0 0.0) (category toiletries) (grasp 2))
	(item (type Objects) (name soap) (zone bathroom_s_cabinet) (image soap) (attributes pick) (pose 0.0 0.0 0.0) (category toiletries))
	(item (type Objects) (name cloth) (zone bathroom_s_cabinet) (image cloth) (attributes pick) (pose 0.0 0.0 0.0) (category toiletries))
	(item (type Objects) (name sponge) (zone bathroom_s_cabinet) (image sponge) (attributes pick) (pose 0.0 0.0 0.0) (category toiletries))
	(item (type Objects) (name tooth_paste) (zone bathroom_s_cabinet) (image tooth_paste) (attributes pick) (pose 0.0 0.0 0.0) (category toiletries))


	;;;; CONTAINERS
	;(item (type Objects) (name bowl)(zone counter)(image bowl)(attributes pick)(pose -3.55 -3.0 0.0) (category containers)(biggest yes))
	(item (type Objects) (name tray)(zone counter)(image tray)(attributes pick)(pose -3.55 -3.0 0.0) (category containers)(room kitchen))
	...
	(item (type Objects) (name box)(zone counter)(image plate)(attributes pick)(pose -3.55 -3.0 0.0) (category containers)(room kitchen))
	(item (type Objects) (name bag)(zone counter)(image plate)(attributes pick)(pose -3.55 -3.0 0.0) (category containers)(room kitchen))

	;;;;; FRUITS
	(item (type Objects) (name apple) (zone dining_table) (image apple) (attributes pick) (pose 0.0 0.0 0.0) (category fruits) (room dining_room))
	(item (type Objects) (name melon) (zone dining_table) (image melon) (attributes pick) (pose 0.0 0.0 0.0) (category fruits) (room dining_room))
	(item (type Objects) (name banana) (zone dining_table) (image banana) (attributes pick) (pose 0.0 0.0 0.0) (category fruits) (room dining_room))
	(item (type Objects) (name pear) (zone dining_table) (image pear) (attributes pick) (pose 0.0 0.0 0.0) (category fruits) (room dining_room))
	(item (type Objects) (name peach) (zone dining_table) (image peach) (attributes pick) (pose 0.0 0.0 0.0) (category fruits) (room dining_table))

	;;;; CUTLERY
	(item (type Objects) (name tea_spoon) (zone cutlery_drawer) (image tea_spoon) (attributes pick) (pose 0.0 0.0 0.0) (category cutlery) (room dining_room))
	(item (type Objects) (name spoon) (zone cutlery_drawer) (image spoon) (attributes pick) (pose 0.0 0.0 0.0) (category cutlery) (room dining_room))
	(item (type Objects) (name fork) (zone cutlery_drawer) (image fork) (attributes pick) (pose 0.0 0.0 0.0) (category cutlery) (room dining_room))
	(item (type Objects) (name knife) (zone cutlery_drawer) (image knife) (attributes pick) (pose 0.0 0.0 0.0) (category cutlery) (room dining_room))
	(item (type Objects) (name napkin) (zone cutlery_drawer) (image napkin) (attributes pick) (pose 0.0 0.0 0.0) (category cutlery) (room dining_room))

	;;;; TABLEWARE
	(item (type Objects) (name big_dish) (zone sideboard) (image big_dish) (attributes pick) (pose 0.0 0.0 0.0) (category tableware) (room dining_room))
	(item (type Objects) (name small_dish) (zone sideboard) (image small_dish) (attributes pick) (pose 0.0 0.0 0.0) (category tableware) (room dining_room))
	(item (type Objects) (name bowl) (zone sideboard) (image bowl) (attributes pick) (pose 0.0 0.0 0.0) (category tableware) (room dining_room))
	(item (type Objects) (name glass) (zone sideboard) (image glass) (attributes pick) (pose 0.0 0.0 0.0) (category tableware) (room dining_room))
	(item (type Objects) (name mug) (zone sideboard) (image mug) (attributes pick) (pose 0.0 0.0 0.0) (category tableware) (room dining_room))
